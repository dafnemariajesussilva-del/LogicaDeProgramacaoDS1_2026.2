...
valor_total_investido_= float(input("valor investido:"))
numero_cliques_obtidos = float(input("numero de cliques:"))
total =valor_total_investido_ / numero_cliques_obtidos
print(f"o valor por clique e: {total}")